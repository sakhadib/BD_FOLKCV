    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-100 p-4">
      <div className="bg-stone-50 p-6 sm:p-8 rounded-2xl w-full max-w-md border border-stone-200">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-stone-700 mb-2">Create Account</h1>
          <p className="text-stone-500 text-sm sm:text-base">Join as an annotator</p>
        </div>
